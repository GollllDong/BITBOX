...
public class TodoDao {
	...
	public static int categoryDaily(TodoList todo) throws Exception {
		...
		// SQL 쿼리문 작성
		String sql = "INSERT INTO todolist (todolist_category, todolist_content, user_id ) VALUES (?, ?, ?)";
...
//
//		// SQL 쿼리문 작성
//		String sql = "INSERT INTO todolist (todolist_category, todolist_content) VALUES (?, ?)";
//		try (PreparedStatement pstmt = DBConnection.getConnection().prepareStatement(sql)) {
//			// PreparedStatement에 값 설정
//			pstmt.setString(1, todo.getTodolist_category());
//			pstmt.setString(2, todo.getTodolist_content());
